...
namespace HealthJournal_API.Migrations
{
    ...
    [Migration("20250614195840_Add-HealthReportConfigs")]
    partial class AddHealthReportConfigs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HealthJournal_API.Models.Domain.HealthReportConfig", b =>
                {
                    ...
                    b.OwnsOne("HealthJournal_API.Models.Domain.ColorCodeConfiguration", "ColorCodeConfig", b1 =>
                        {
                            b1.Property<int>("HealthReportConfigId")
                                .HasColumnType("integer");
                            ...
                            b1.HasKey("HealthReportConfigId");

                            b1.ToTable("HealthReportConfigs");
                            ...
                            b1.OwnsMany("HealthJournal_API.Models.Domain.FilterClause", "Clauses", b2 =>
                                {
                                    ...
                                    b2.HasKey("ColorCodeConfigurationHealthReportConfigId", "Id");

                                    b2.ToTable("HealthReportConfigs_Clauses");

                                    b2.WithOwner()
                                        .HasForeignKey("ColorCodeConfigurationHealthReportConfigId");
                                });
